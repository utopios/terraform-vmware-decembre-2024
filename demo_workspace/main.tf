terraform {
  ...
  backend "http" {
    address = terraform.workspace == "prod" ?  "http://prod.adresse_vers_backend.net/backend.json?token=authentificationtoken" :"http://dev.adresse_vers_backend.net/backend.json?token=authentificationtoken"
  }
}
